...
@section('admin')
  ...
  <div class="page-content">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
      <div>
        <h4 class="mb-3 mb-md-0">Welcome to RSBD Admin Panel</h4>
      </div>
      ...
      <div class="col-lg-12 col-xl-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="text-muted">Sales are activities related to selling or the number of goods or services sold in a
              given time period.</p>
